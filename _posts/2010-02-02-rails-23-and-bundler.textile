...
In "Yehuda's blog post":http://yehudakatz.com/2009/11/03/using-the-new-gem-bundler-today/, he says to insert the follow code in there as well:
...
I couldn't get it to work quite right in the preinitializer.  I instead stuck it in <code>config/boot.rb</code>.
